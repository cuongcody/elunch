...
<div class="right_col" role="main">
    ...
    <!-- <div class="row tile_count">
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-user"></i> <?php echo $home_lang['total_users'] ?></span>
        ...
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-clock-o"></i> <?php echo $home_lang['total_tables'] ?></span>
                <div class="count"><?php echo $number_of_tables ?></div>
            </div>
        </div>
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-user"></i> <?php echo $home_lang['total_menus'] ?></span>
                <div class="count"><?php echo $number_of_menus ?></div>
            </div>
        </div>
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-user"></i> <?php echo $home_lang['total_categories'] ?></span>
        ...
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-user"></i> <?php echo $home_lang['total_shifts'] ?></span>
                <div class="count"><?php echo $number_of_shifts ?></div>
            </div>
        </div>
        <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
            <div class="left"></div>
            <div class="right">
                <span class="count_top"><i class="fa fa-user"></i> <?php echo $home_lang['total_dishes'] ?></span>
                <div class="count"><?php echo $number_of_dishes ?></div>
            </div>
        </div>
    </div> -->
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <?php
                            if (!empty($tables))
                            {
                                ...
                                {
                                    echo '<div id="table_'.$table->id.'" class="col-xs-offset-1 col-xs-8 col-xs-offset-1 col-sm-offset-3 col-sm-6 col-sm-offset-3 col-md-12 tables">';
