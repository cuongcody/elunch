                ...
                <tbody>
                    <?php
                        foreach ($dishes as $key => $dish)
                        {
                            ...
                            echo "<td class='active'>".anchor('admin/dishes/edit/'.$dish->id, substr($dish->description,0,60)."...",'')."</td>";
                            ...
                            echo "<a href='#delete_dish_modal' class='label label-warning' data-toggle='modal' data-target='#delete_dish_modal' data-dish-id={$dish->id} onclick='false;'>".$dishes_lang["delete"]."</a></td>";
                            echo "</tr>";
                        }
                    ?>
                <tbody>
