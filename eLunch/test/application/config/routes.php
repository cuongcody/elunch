...
$route['comment/(:num)'] = 'comments_api/comment/$1';
$route['user/(:num)/comments'] = 'comments_api/comments_of_user/$1';
//Dishes api
$route['dishes'] = 'dishes_api/dishes';
//Admin message api
$route['messages/(:num)'] = 'admin_messages_api/messages/$1';
$route['message/(:num)'] = 'admin_messages_api/message/$1';
$route['message'] = 'admin_messages_api/message';
//Meals
