...
<div class="right_col" role="main">
    <div class="row">
        <div class= 'col-md-offset-1 col-md-10 col-sm-offset-1 col-sm-10 col-xs-12'>
            ...
            <?php echo anchor('admin/shifts/add', $shifts_lang['create_shift'], "class='btn btn-loading btn-primary'"); ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr id="shift_<?php echo $shift->id ?>">
                                        ...
                                        <td class="active"><?php echo anchor('admin/shifts/edit/'.$shift->id, $shifts_lang['edit'], "class='btn-loading label label-info'") ?></td>
                                        <td class="active">
